...
public class GoogleLoginService extends Service {
	...
	public class AccountAuthenticator extends AbstractAccountAuthenticator {
		...
		public Bundle addAccount(final AccountAuthenticatorResponse response, final String accountType,
			...
			if (accountType.equals(GoogleLoginService.this.getString(R.string.account_type))) {
				final Intent i = new Intent(GoogleLoginService.this, LoginActivity.class);
				i.putExtras(options);
				i.putExtra(AndroidManager.KEY_LOGIN_ACTION, LoginActivity.LOGIN_ACTION_ADD_ACCOUNT);
		...
		public Bundle confirmCredentials(final AccountAuthenticatorResponse response, final Account account,
			...
			Log.w(TAG, "Not yet implemented: AccountAuthenticatorImpl.confirmCredentials");
			return null;
		}
		...
		public Bundle editProperties(final AccountAuthenticatorResponse response, final String accountType) {
			...
			Log.w(TAG, "Not yet implemented: AccountAuthenticatorImpl.editProperties");
			return null;
		}

		@Override
		public Bundle getAuthToken(final AccountAuthenticatorResponse response, final Account account,
								   final String service, final Bundle options) throws NetworkErrorException {
			Log.d(TAG, "AccountAuthenticatorImpl.getAuthToken: " + service);
			if (account.type.equals(GoogleLoginService.this.getString(R.string.account_type))) {
				final int uid = options.getInt("callerUid");
				String authToken = androidManager.getAuthToken(service, uid, account);
				if (authToken == null) {
					final String packageName = androidManager.getPackageNameForUid(uid);
					if (packageName.equalsIgnoreCase("com.google.android.apps.plus") ||
						packageName.equalsIgnoreCase("com.android.vending") ||
				...
				if (authToken != null) {
					Log.d(TAG, "AccountAuthenticatorImpl.getAuthToken: got auth token '" + authToken + "', using it");
					final Bundle result = new Bundle();
				...
				Log.d(TAG, "AccountAuthenticatorImpl.getAuthToken: no auth token, responding with intent");
				final Intent i = new Intent(GoogleLoginService.this, LoginActivity.class);
				i.putExtras(options);
				i.putExtra(AndroidManager.KEY_LOGIN_ACTION, LoginActivity.LOGIN_ACTION_AUTH_TOKEN);
				i.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
		...
		public String getAuthTokenLabel(final String authTokenType) {
			// TODO Auto-generated method stub
			Log.w(TAG, "Not yet implemented: AccountAuthenticatorImpl.getAuthTokenLabel");
			return null;
		}
		...
		public Bundle hasFeatures(final AccountAuthenticatorResponse response, final Account account,
			...
			// TODO Auto-generated method stub
			Log.w(TAG, "Not yet implemented: AccountAuthenticatorImpl.hasFeatures");
			Bundle b = new Bundle();
		...
		public Bundle updateCredentials(final AccountAuthenticatorResponse response, final Account account,
			...
			// TODO Auto-generated method stub
			Log.w(TAG, "Not yet implemented: AccountAuthenticatorImpl.updateCredentials");
			return null;
		}
	...
	public class LoginService extends IGoogleLoginService.Stub {
		...
		@Override
		public GoogleLoginCredentialsResult blockingGetCredentials(final String username, final String service,
																   final boolean notifyAuthFailure)
				throws RemoteException {
			// TODO Auto-generated method stub
			Log.w(TAG, "Not yet implemented: LoginService.blockingGetCredentials");
			return null;
		}
		...
		@Override
		public void deleteOneAccount(final String username) throws RemoteException {
			// TODO Auto-generated method stub
		...
		@Override
		public String getAccount(final boolean requireGoogle) throws RemoteException {
			// TODO Auto-generated method stub
		...
		@Override
		public void invalidateAuthToken(final String authtokenToInvalidate) throws RemoteException {
			// TODO Auto-generated method stub
		...
		@Override
		public String peekCredentials(final String username, final String service) throws RemoteException {
			throw new UnsupportedOperationException("Deprecated");
		}

		@Override
		public void saveAuthToken(final String account, final String service, final String authtoken)
				throws RemoteException {
			throw new UnsupportedOperationException("Deprecated");
		}
		...
		@Override
		public void saveUsernameAndPassword(final String username, final String password, final int flags)
				throws RemoteException {
			throw new UnsupportedOperationException("Deprecated");
		}
		...
		@Override
		public boolean verifyStoredPassword(final String username, final String password) throws RemoteException {
			throw new UnsupportedOperationException("Deprecated");
		}
	...
	public IBinder onBind(final Intent intent) {
		...
		} else if (intent.getAction().equals("com.google.android.gsf.action.GET_GLS")) {
			return loginService;
		}
		return null;
	}
